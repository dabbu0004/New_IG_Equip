...
const homeProductsRangeData = [
{
    ...
    },
    {
        ...
        overviewText:
            "A Retrofit Emission Control Device (RECD) is an advanced pollution control system installed in diesel generators (DG sets) to reduce harmful exhaust emissions.It is designed to control particulate matter (PM), black smoke, and toxic gases released during generator operation. RECD helps diesel generators meet environmental standards set by the Central Pollution Control Board (CPCB) in India.",
        overviewExtraText:
