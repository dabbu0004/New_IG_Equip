      ...
      <div className="w-[80%] mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
        ...
        <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left">
          ...
          <p className="text-gray-600 text-base lg:text-lg">
            Power your business with gas gensets—cut energy <br /> costs, reduce your carbon footprint, and ensure <br /> 24/7 efficiency. A smart step toward sustainable <br /> profitability.
          </p>
