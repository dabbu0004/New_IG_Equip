    ...
    <div className="max-w-6xl mx-auto px-6 py-12  rounded-xl ">
      ...
      <div className="bg-white p-6 rounded-lg  mb-8">
        <p className="text-gray-600 mb-6 leading-relaxed text-lg">
          Moreover, the Eo Energy RECD aligns perfectly with the guidelines set
          forth by the National Green Tribunal and Central Pollution Control
          Board. These pollution control devices can boost the reduction
          efficiency by more than 90% for Hydrocarbons (HC), Particulate Matter
          (PM), and Carbon Monoxide (CO).
        </p>

        <p className="font-semibold text-xl text-gray-700 mb-6 flex items-center justify-center">
          <span className="mr-2 text-orange-500">✓</span>
          Here check the list of pollution control equipment for Genset based on
          its size & power output.
        </p>
      </div>
