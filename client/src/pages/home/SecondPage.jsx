    ...
    <section className="container mx-auto max-w-7xl bg-white px-4 md:px-20 py-10">
      ...
      <div className="text-center mb-8">
        <h2 className="text-xl sm:text-2xl md:text-4xl font-bold leading-snug">
          <span className="font-extrabold italic block">
            Shaping the Future of Clean Energy with
          </span>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-10">
        ...
        <div className="mb-10 md:mb-0 w-full md:w-1/2">
          ...
          <h3 className="text-2xl sm:text-4xl font-extralight mb-2">
            IG Equipment -
          </h3>
          <p className="text-xl sm:text-3xl font-extralight">
            Offering Smarter Gas
            <br />
        ...
        <div className="space-y-6 text-base sm:text-2xl w-full md:w-1/2">
          <div className="flex items-start gap-4">
            ...
            <p>
              Cut down on energy usage with advanced, proven energy-smart
              technologies
            </p>
          </div>
          <div className="flex items-start gap-4">
            ...
            <p>
              Enjoy zero upfront investment through our save-as- you-go payment
              model
            </p>
          </div>
          <div className="flex items-start gap-4">
            ...
            <p>
              Upgrade your infrastructure with future-ready, clean energy
              systems
            </p>
          </div>
