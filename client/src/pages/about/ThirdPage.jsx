      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between px-4 sm:px-6 lg:px-20 py-12 text-white gap-10">
        ...
        >
          <div className="inline-block bg-gradient-to-r from-red-500 to-orange-400 px-4 py-2 rounded-xl mb-4">
            <h2 className="text-white font-bold text-lg md:text-xl">Why Choose Us?</h2>
          </div>
          <p className="mb-6 text-base sm:text-lg">Some of the benefits offered by IGE are:</p>

          <ul className="space-y-6 text-base sm:text-lg lg:text-2xl">
            <li>
              <span className="text-white">● </span>
              <span className="font-bold">Customized Solutions:</span> Every business is unique, and so are we. <br className="hidden lg:block" />
              We design systems tailor-made for you.
            </li>
            <li>
              <span className="text-white">● </span>
              <span className="font-bold">Uncompromising Quality:</span> From design to delivery, <br className="hidden lg:block" />
              quality is our highest priority.
            </li>
            <li>
              <span className="text-white">● </span>
              <span className="font-bold">Sustainability Focused:</span> Our products help lower the <br className="hidden lg:block" />
              carbon footprint and improve energy efficiency.
            </li>
            <li>
              <span className="text-white">● </span>
              <span className="font-bold">Expert Support:</span> Our trained experts will always <br className="hidden lg:block" />
