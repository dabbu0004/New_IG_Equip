        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
          ...
          <div className="lg:w-1/2 space-y-4">
            ...
            <h2 className="text-4xl font-semibold text-black ">
              IG Equipment –<br />
              Switch Diesel Gensets to <br /> Gas with Dual Fuel Kits – Go{" "}
              <br /> Cleaner, Go Smarter!
            </h2>
          </div>
          ...
          <div className="lg:w-1/2 space-y-4 text-2xl">
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-700">
                Cut down on energy usage with advanced, proven <br />{" "}
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-700">
                Enjoy zero upfront investment through our save-as <br /> -
                you-go payment model
              </p>
            </div>
            <div className="flex items-start gap-3">
              <FaArrowAltCircleUp className="text-orange-500 text-xl mt-1" />
              <p className="text-gray-700">
                Upgrade your infrastructure with future-ready, <br /> clean
                energy systems
              </p>
            </div>
