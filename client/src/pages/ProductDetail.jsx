...
const ProductDetail = () => {
  ...
  const renderOverviewIcon = (iconName) => {
    switch (iconName) {
      case "service": return <FiTool className="text-[#f48131] text-xl" />;
      case "support": return <FiHeadphones className="text-[#f48131] text-xl" />;
      case "reliability": return <BsShieldCheck className="text-[#f48131] text-xl" />;
      case "performance": return <BsGearWideConnected className="text-[#f48131] text-xl" />;
      case "capacity": return <BsLightningCharge className="text-[#f48131] text-xl" />;
      default: return <FiSettings className="text-[#f48131] text-xl" />;
    }
  };
  ...
  return (
    <div className="w-full bg-[#fcfcfc] font-sans pb-20">
      ...
      >
      <img
        src={product?.heroBannerMobile || product?.heroBanner || "/images/ProductsBanner/gas-geset-banner.png"}
        alt=""
        aria-hidden="true"
      ...
      <section className="max-w-8xl mx-auto px-4 sm:px-6 md:px-12 -mt-8 relative z-20 fade-in-section">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 flex flex-wrap lg:flex-nowrap items-center justify-between gap-6 lg:gap-4 divide-y lg:divide-y-0 lg:divide-x divide-gray-100">
          ...
          <div key={idx} className="flex flex-col items-center text-center w-full sm:w-[45%] lg:w-1/5 pt-4 lg:pt-0 first:pt-0">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 pt-20 pb-10 flex flex-col md:flex-row gap-12 fade-in-section">
        ...
        <div className="w-full md:w-8/12 flex flex-col">
          <h2 className="text-2xl font-bold text-gray-900 mb-4  border-b-2 border-gray-100 w-max">Overview</h2>
        ...
        <div className="w-full md:w-4/12 flex flex-col md:items-end">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 self-start border-b-2 border-gray-100 w-max">Technical Specifications</h2>
          <div className="w-full max-w-lg">
          <div className="overflow-hidden border border-gray-200 rounded-xl shadow-sm">
            <table className="w-full text-left text-sm">
            <thead className="bg-gray-50 text-gray-700">
              <tr>
              <th className="px-5 py-3 font-bold border-b border-gray-200 w-1/3">Parameter</th>
              <th className="px-5 py-3 font-bold border-b border-gray-200">Details</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100 bg-white">
              {(product?.technicalSpecs || []).map((spec, idx) => (
              <tr key={idx} className="hover:bg-gray-50/50 transition">
                <td className="px-5 py-3 font-medium text-gray-700">{spec.parameter}</td>
          ...
          {/* <div className="rounded-xl border border-orange-100 bg-orange-50/60 p-5 shadow-sm">
            ...
            Our team can help with detailed technical information and site requirements.
            </p>
            <div className="text-sm text-gray-700 space-y-2 mb-4">
            <p>+91 12345 67890</p>
            <p>info@inventivegasequipment.com</p>
            </div>
            <button className="w-full rounded-md bg-[#f48131] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#e06d1f]">
            Contact Our Experts
            </button>
          </div> */}
          </div>
      ...
      style={{
      backgroundImage: "url('/images/ProductsBanner/LowerBanner.png')"
      }}
      >
      <img
      ...
      <div className="flex flex-col lg:flex-row gap-10 items-center">
        ...
        <div className="flex flex-wrap gap-4">
          {(product?.keyBenefits || []).slice(0, 3).map((benefit, idx) => (
          <div key={idx} className="flex w-full sm:w-[calc(50%-8px)] lg:w-[calc(33.333%-10.7px)] items-center gap-3 rounded-xl border border-gray-200 bg-white/90 px-5 py-4 shadow-sm">
