            ...
            <button
              ...
              className={`px-6 py-2 rounded-full font-medium transition-all duration-200 transform hover:scale-105 ${
                activeCategory === category
                  ? "bg-[#f48131] text-white shadow-lg"
                  : "bg-white text-gray-700 hover:bg-[#f48131] border border-gray-200 hover:border-orange-200"
              }`}
            >
              {category}
            </button>
          ...
          <div className="relative max-w-6xl max-h-screen w-full h-full flex items-center justify-center p-4">
            ...
            {selectedImageIndex > 0 && (
              <button
                ...
                className="absolute left-4 top-1/2 transform -translate-y-1/2 z-10 bg-[#f48131] hover:bg-[#f48131] text-white p-3 rounded-full transition-all duration-200 backdrop-blur-sm"
              >
            ...
            {selectedImageIndex < displayedImages.length - 1 && (
              <button
                onClick={goToNext}
                className="absolute right-4 top-1/2 transform -translate-y-1/2 z-10 bg-[#f48131] hover:bg-[#f48131] text-white p-3 rounded-full transition-all duration-200 backdrop-blur-sm"
              >
