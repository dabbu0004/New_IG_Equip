          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p>
                ...
                inventive tapestry created with passion. As a new business, we
                are living examples of the value of commitment and a
                never-ending quest for greatness.
              </p>
            ...
            <div className="lg:w-1/2 space-y-10">
              <div className="flex gap-6 items-start">
                ...
                <div>
                  <p className="text-lg">
                    Reduce your energy consumption by using only the latest,
                    most trusted energy-efficient technologies
                  </p>
                </div>
              </div>
