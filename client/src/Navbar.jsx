      ...
      <header className="container mx-auto max-w-7xl relative bg-white shadow-md z-50 rounded-bl-[2rem]">
        ...
        <div className="relative z-10 flex items-center justify-between px-4 md:px-16 py-4">
          ...
          <nav className="hidden md:flex space-x-10 font-medium text-black text-lg">
            ...
            <Link to="/retrofit-emission-control-device-recd" className="hover:text-orange-500 transition-colors">Vayu Pure RECD</Link>
            <Link to="/dual-fuel-kit" className="hover:text-orange-500 transition-colors">Dual-Fuel Kit</Link>
            <Link to="/gas-ganset" className="hover:text-orange-500 transition-colors">Gas Ganset</Link>
            <Link to="/biogas" className="hover:text-orange-500 transition-colors">Bio Gas</Link>
            <Link to="/career" className="hover:text-orange-500 transition-colors">Career</Link>
        ...
        {/* Mobile Menu Overlay */}
        <div className={`md:hidden fixed inset-0 bg-black bg-opacity-50 z-30 transition-opacity duration-300 ${isMenuOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
